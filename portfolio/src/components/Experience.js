...
const Jobs = () => {
  let jobsList = [
    [ 'Full Stack Developer', 
      ...
      '08/2022 - 12/2022', 
      'Brazil', 
      'Back-end development of a sports betting application with Node.js, SQL Server. Component development in React Native for other projects.'],
    ...
    [ 'Intern - Engineering', 
      ...
      '10/2017 - 10/2018', 
      'Brazil', 
      'Internship in a construction company performing activities like: budget spreadsheet automation, administrative processes, budget adjustments, etc.'],
    [ 'Intern - Engineering', 
      'Águas e Esgotos do Piauí - Agespisa',
      'https://pt.wikipedia.org/wiki/%C3%81guas_e_Esgotos_do_Piau%C3%AD', 
      '05/2018 - 10/2018', 
      'Brazil', 
      'Internship at a water company providing assistance in the preparation of technical reports on the quality of water and the sanitation structure of cities in the state of Piauí-Brazil; checking the physical-chemical and bacteriological patterns of the samples; generating static summaries that contributed to quality control and simplifying bureaucratic procedures.'],
  ]
